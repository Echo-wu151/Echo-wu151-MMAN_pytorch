...
class HyperDenseNet_2Mod(nn.Module):
    ...
    def forward(self, input):
        ...
        #print('inputFully',inputFully.shape)
        y = self.fully_1(inputFully)
        y = self.fully_2(y)
        y = self.fully_3(y)
        #print('y',y.shape)
        # print('final',self.final(y).size())
        return self.final(y)
